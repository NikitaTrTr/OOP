...
/**
 * Benchmark for parallel prime checker.
 */
@State(Scope.Benchmark)
@BenchmarkMode(Mode.AverageTime)
@OutputTimeUnit(TimeUnit.NANOSECONDS)
public class BenchmarkForParallelPrimeChecker {
    ...
    @Benchmark
    public void parallelCheckerTest(Blackhole blackhole) {
        ParallelStreamChecker checker = new ParallelStreamChecker(data);
